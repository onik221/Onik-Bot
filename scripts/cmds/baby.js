    ...
    if (event.type !== "message_reply" && mahmud.some(word => message.startsWith(word))) {
      ...
      const res = await axios.post(`${await baseApiUrl()}/api/hinata`, { text, style: 3, attachments });  return res.data.message; } catch {  return "error janu🥹";
       ...
       const randomMessage = [
          ...
          "~২ ঘঁন্টাঁ কাঁ’দাঁ’রঁ পঁরঁ,,,!!😰😭~ হঁটাঁৎ  মঁনে হলো 🤔~𝐈 𝐚𝐦 𝐭𝐨 সিঙ্গেল,,,😁",
          "🌼🥀ডিয়ার তারছ্যাড়া এডমিন !! 🥱🌻🌹🌼 মন খালি তুই তুই করে!!😍😍বলতে পারি নাহ রিমুভের ভয়ে!!🤭♥__ সারাদিন কই থাকছ!!🥀🍁গুরুপে দেখি না তোরে,,🤣😁",
          "-༅༎🍁❥━༎ຶপ্রেমে পড়তে চাইছিলাম🌻-উষ্টা খাইয়া বাশ বাগানে পড়ে গেছি-༎ຶ🤧🥵🥀-😌🙈",
          "বলো কি বলবা, সবার সামনে বলবা নাকি?🤭🤏",  
          "𝗜 𝗹𝗼𝘃𝗲 𝘆𝗼𝘂__😘😘",
          "𝗜 𝗵𝗮𝘁𝗲 𝘆𝗼𝘂__😏😏",
          "গোসল করে আসো যাও😑😩",
          "অ্যাসলামওয়ালিকুম",
          "°SMS না দিলে আইডি খুলছোস ক্যান°🤨😤 __ননসেন্স বেডি .!😒😾দে SMS দে 🤭 এক্ষুনি দিবি 🫡",
          "– বাংলাদেশের দুইটা ফেমাস ঔষুধ.!😊🤗(১)𝐍𝐚𝐩𝐚💊💊 (২)𝐔𝐦𝐦𝐦𝐚𝐡💋😘– বাবু সুস্থ.!😬🐸",
          "–রিলেশনশিপে যাচ্ছি,গেলে আসেন!!🤫ভাড়া লাগলে আমি দিমু!!😑🐸🐸–",
          ...
          "বয়সটা প্রেম করার,,😇🥀 //অভাব টা সিঙ্গেল বেডির 🙂🔨",
